...
Router.get("/introduction", function (req, res) {
    res.render("client/pages/introduction", {title: "Introduction", url: req.url});
});
Router.get("/location", function (req, res) {
    res.render("client/pages/location", {title: "Location", url: req.url});
});
Router.get("/locationSelection", function (req, res) {
    res.render("client/pages/locationSelection", {title: "Location", url: req.url});
});
Router.get("/profile", function (req, res) {
    res.render("client/pages/profile", {title: "Profile", url: req.url,screenTitle:'Profile',cartCount:0});
});
